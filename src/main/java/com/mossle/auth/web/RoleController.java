...
public class RoleController {
    ...
    public String list(Pageable pageable,
        ...
        model.addAttribute("page", tools.listForPage(tenantHolder, pageable, parameterMap, roleManager,"Role","name"));
...
//            dest.setRoleDef(roleDefManager.get(roleDefId));
            dest=(Role)Tools.mySave(role, roleDefManager, beanMapper, null, null,
            		new RoleController_Save(roleDefManager,roleDefId));
    ...
    public String viewList(Pageable pageable,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    		Tools tools=new Tools();
        model.addAttribute("page", tools.listForPage(tenantHolder, pageable, parameterMap, roleManager,"Role","name"));
    ...
    public String viewInput( @RequestParam(value = "id", required = false) Long id, Model model) {
        Tools.infoInput(roleManager, model, id);

...
import com.funs.GroupInfoController_savaSetNewValue;
...
public class GroupInfoController {
    ...
    public String list(Pageable pageable,@RequestParam Map<String, Object> parameterMap, Model model) {
        ...
        model.addAttribute("page", tools.listForPage(tenantHolder, pageable, parameterMap, groupInfoManager,"GroupInfo","name"));
    ...
    public String input(@RequestParam(value = "id", required = false) Long id,Model model) {
        Tools.infoInput(groupInfoManager, model, id);
...
//        groupInfoManager.save(dest);
        dest=(GroupInfo)Tools.mySave(groupInfo, groupInfoManager, beanMapper, 
        		new GroupInfoController_savaSetNewValue(tenantId),null,null);
        groupInfoManager.save(dest);

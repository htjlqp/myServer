...
public class AccountDeviceController {
    ...
    public String list(Pageable pageable,@RequestParam Map<String, Object> parameterMap, Model model) {
        ...
        model.addAttribute("page", tools.listForPage(tenantHolder, pageable, parameterMap, accountDeviceManager,"AccountDevice"));
    ...
    public String input(@RequestParam(value = "id", required = false) Long id,Model model) {
        Tools.infoInput(accountDeviceManager, model, id);
        return "user/account-device-input";
    }

    public void saveSetValue(AccountDevice dest,String tenantId){
    ...
    public String save(
        ...
        dest=(AccountDevice)Tools.mySave(accountDevice, accountDeviceManager, beanMapper, 
        		new AccountDeviceController_saveSetValue(tenantId),
        		new AccountDeviceController_saveSetOldValue(),null);

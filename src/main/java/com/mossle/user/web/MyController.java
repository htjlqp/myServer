...
public class MyController {
    ...
    public String infoInput(Model model) {
		...
		accountInfo_PersonInfo(accountInfo,personInfo);
        model.addAttribute("accountInfo", accountInfo);
        model.addAttribute("personInfo", personInfo);
        return "user/my-info-input";
    }
    private void accountInfo_PersonInfo(AccountInfo accountInfo,PersonInfo dest){
        Long accountId = Long.parseLong(currentUserHolder.getUserId());
        accountInfo= accountInfoManager.get(accountId);
        dest = personInfoManager.findUniqueBy("code",accountInfo.getCode());
    }
    private void personInfoSetAndCopy(AccountInfo accountInfo,PersonInfo dest,PersonInfo personInfo){
        dest = new PersonInfo();
    ...
    public String infoSave(@ModelAttribute PersonInfo personInfo,
    		...
    		accountInfo_PersonInfo(accountInfo,dest);
        if (dest != null)
            beanMapper.copy(personInfo, dest);
        else
        		personInfoSetAndCopy(accountInfo,dest,personInfo);
    ...
    public String changePasswordSave(String oldPassword,String newPassword,String confirmPassword,RedirectAttributes redirectAttributes) {
        Long accountId = Long.parseLong(currentUserHolder.getUserId());
